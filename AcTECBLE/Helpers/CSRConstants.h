...
#define kSceneRemotesFourKeys @[@"TR4B",@"PR4B"]
#define kSceneRemotesThreeKeys @[@"TR3B",@"PR3B"]
#define kSceneRemotesTwoKeys @[@"TR2B",@"PR2B"]
#define kSceneRemotesOneKey @[@"TR1B",@"PR1B"]
