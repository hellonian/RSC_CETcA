...
-(BOOL) initMain {
    ...
    if (!success && !otauRunning) {
        ...
        [[CSRBluetoothLE sharedInstance] disconnectPeripheral: targetPeripheral];
...
/****************************************************************************/
/*	     		    	CSRBluetoothLEDelegate delegates                    */
/****************************************************************************/

//============================================================================
// Reuse the CSRBluetoothLEDelegate singleton to route callbacks from CBCentral
//
