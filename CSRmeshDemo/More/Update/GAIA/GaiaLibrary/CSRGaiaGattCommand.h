 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandType) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandStatus) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandUpdate) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandUpdateResponse) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaEvent) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandFeature) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaCommandAction) {
...
/**
 @enum GaiaCommandAction - continue or abort
 */
typedef NS_ENUM(NSInteger, GaiaUpdateResumePoint) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaAVControlOperation) {
 ...
 */
typedef NS_ENUM(NSInteger, GaiaAudioSource) {
